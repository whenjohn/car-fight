...
After acceptance, the normal mixed launcher retains `P` cruise for repeatable
driving comparisons but leaves `L` motion tracing disabled. Ordinary play
enables neither; the harness controls remain explicit environment options.
