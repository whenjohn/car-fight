...
- When rendered testing is authorized, repeat the ordinary-versus-assisted corner comparison. The new ordinary inward pull should visibly skid but run wide enough to miss a tight 90-degree racing line; the latched drift should be the clear way to make it at speed.
