...
- When rendered testing is authorized, reach full speed, pull into a rear-corner wedge, and confirm the chosen wedge still snaps bright with `DRIFT ASSIST` even as braking lowers road speed. Then stop chasing it while the auto-drift carries into a side skid, and throw the cursor far forward to accelerate out.
