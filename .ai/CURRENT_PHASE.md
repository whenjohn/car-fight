...
- When rendered testing is authorized, verify the new warm-white max-speed dot reads clearly ahead of the live cursor dot at partial throttle and remains visible when both meet at full throttle. Then continue comparing the ordinary broad skid against the tighter assisted 90-degree corner.
