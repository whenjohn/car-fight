...
const MIN_GRIP_SCALE := 0.05
const MIN_DRIFT_ASSIST_SCALE := 0.12
const TURN_MULTIPLIER := 5.0
const YAW_MOMENTUM := 0.82
const YAW_ACCELERATION_SCALE := 1.70
const FISHTAIL_YAW_RATE := 3.20
const FISHTAIL_FREQUENCY_MIN := 7.5
const FISHTAIL_FREQUENCY_MAX := 12.0
const MAX_YAW_RATE := 7.0
