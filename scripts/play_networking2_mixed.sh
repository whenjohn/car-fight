...
echo "Press P in either client to toggle its client-generated full-speed/non-burst cruise."
echo "Press L to start/stop that client's presented-motion trace; each new start archives telemetry and clears the visible line."
