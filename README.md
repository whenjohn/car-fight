...
arena ball, shield-test drone, interactive grass, and local cursor marker,
leaving only the two Jeeps and static arena presentation. The observer Jeep is
cyan and the server-driven Jeep is orange. A
